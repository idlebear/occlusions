...
def main(args):
    ...
    if args.debug:
        ...
        env = PedestrianEnv(num_actors=args.actors, seed=args.seed)
    else:
        if args.multipass:
            env = make_vec_env(PedestrianEnv, n_envs=args.instances, env_kwargs={'num_actors': args.actors, 'seed': args.seed, }, )
        else:
            env = make_vec_env(PedestrianEnv, n_envs=args.instances, env_kwargs={'num_actors': args.actors, 'seed': args.seed, })
